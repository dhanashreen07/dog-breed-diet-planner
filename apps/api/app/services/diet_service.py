    ...
    async def generate_for_pet(
        ...
        plan = DietPlan(
            ...
            food_recommendations=result.food_recommendations,
                ...
                weekly_protein_g=Decimal(str(round(float(result.protein_g) * 7, 2))),
                weekly_fat_g=Decimal(str(round(float(result.fat_g) * 7, 2))),
                weekly_carbs_g=Decimal(str(round(float(result.carbs_g) * 7, 2))),
